...
#define AX_LED                      25 //LED
#define AX_CW_COMPLIANCE_MARGIN     26 //D
#define AX_CCW_COMPLIANCE_MARGIN    27 //I
#define AX_CW_COMPLIANCE_SLOPE      28 //P
...
//Stuff we added
//PID Control
#define SetP(id, p) (ax12SetRegister(id, 28, p))
#define SetI(id, i) (ax12SetRegister(id, 27, i))
#define SetD(id, d) (ax12SetRegister(id, 26, d))

//LED Control
#define SetLED(id, led) (ax12SetRegister(id, 25, led))

//EEProm Lock
#define EEPromLock(id,lock) (ax12SetRegister(id, 47, lock))
